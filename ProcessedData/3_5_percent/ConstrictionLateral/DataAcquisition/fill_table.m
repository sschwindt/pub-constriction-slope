...
clear variables;
close all;
sourceName = '20160421_data_lateral.xlsx';
...
h = xlsread(sourceName, 1, 'F13:J128');
% get discharges
Q = xlsread(sourceName, 1, 'D13:D128');
temp_Qb = xlsread(sourceName, 1, 'E13:E128');
Qb = nan(size(Q));
Qb(1:numel(temp_Qb)) = temp_Qb;
% get opening width
b = xlsread(sourceName, 1, 'K13:K128');
...
targetRange = 'L13:R128';

% write data
xlswrite(sourceName,[bRel,alphaQ,qbxRel,Fr, hh, taux,eta,tauNC], 1, targetRange);
xlswrite(sourceName,tauNC, 1, 'T13:T128');
xlswrite(sourceName,[ zeta, dEc, mu ], 1, 'U13:W128');
disp('Data processed.');
