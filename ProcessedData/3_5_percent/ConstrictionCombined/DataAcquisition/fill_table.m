...
b = xlsread(sourceName, 1, 'M13:M132');
Ac = xlsread(sourceName, 1, 'N13:N132');
...
for dq = 1:numel(Q)
    ...
    [h0, H0, mu(dq), tauxc] = ...
                             fGetHmu(Q(dq), h(dq,4), a(dq), b(dq), Qb(dq));
    aH0(dq) = a(dq)/H0;
    ah0(dq) = a(dq)/h(dq,4);
    HH (dq) = Hnc/H0;
    hh (dq) = hnc4/h(dq,4);
...
xlswrite(sourceName,[ zeta, dEc,mu, muh ], 1, 'Y13:AB132');
