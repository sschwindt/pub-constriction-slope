function [ H0, mu, tau ] = fGetHmu( Q, h4,a , b )
...
%% ORIGINAL
% mu = 3*Q/sqrt(8*g)*(wcc*(H0^(3/2)-(H0-(b-wcc)/2*tand(alphac))^(3/2))+...
%        2*H0/tand(alphac) *(H0^(3/2)-(H0-(b-wcc)/2*tand(alphac))^(3/2))-...
%          6/5/tand(alphac)*(H0^(5/2)-(H0-(b-wcc)/2*tand(alphac))^(5/2))+...
%            b*((H0-(b-wcc)/2*tand(alphac))^(3/2)-(H0-a)^(3/2)))^-1;
