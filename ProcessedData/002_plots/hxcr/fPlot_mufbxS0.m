function[] = fPlot_mufbxS0(x_a, x_b, the_a, the_b, xInterp_a, ...
...
% create plot of mu 2p-lat
plot1(numel(plot1)+1) = plot(the_a(:,1),y_b2(:,1),...
    'Color',colors(7,:),...
    'LineWidth',1,'LineStyle',lStyles{1,1},...
    'Marker',mStyles_b{1,3},'MarkerSize',MarkerS,...
...
% create plot of mu 4p-lat
plot1(numel(plot1)+1) = plot(the_a(:,2),y_b2(:,2),...
    'Color',colors(7,:),...
    'LineWidth',1,'LineStyle',lStyles{1,1},...
    'Marker',mStyles_b{1,2},'MarkerSize',MarkerS,...
    'MarkerFaceColor',mColorLat+0.502,...
...
% create plot of mu 6p-lat
plot1(numel(plot1)+1) = plot(the_a(:,3),y_b2(:,3),...
    'Color',colors(7,:),...
    'LineWidth',1,'LineStyle',lStyles{1,1},...
    'Marker',mStyles_b{1,1},'MarkerSize',MarkerS,...
    'MarkerFaceColor',mColorLat+0.502,...
...
subplot2 = subplot(1,2,2,'Parent',figure1,'FontSize',fontS,...
    'FontName','TimesNewRoman','GridLineStyle','-',...
    'XTickLabel',{'0.000','0.002','0.004','0.006','0.008','0.010'},...
    'XTick',0.0:0.002:0.01,...
    'YTickLabel',{'','0.25','0.50','0.75','1.00','1.25','1.50'},...
    'YTick',0.0:0.25:1.5,...
    'LineWidth', 3);
hold(subplot2,'all');
...
% create plot of mu 4p-lat
plot2(numel(plot2)+1) = plot(x_b(:,2)*I(2),y_b2(:,2),...
    'Color',colors(7,:),...
    'LineWidth',1,'LineStyle',lStyles{1,1},...
    'Marker',mStyles_b{1,2},'MarkerSize',MarkerS,...
    'MarkerEdgeColor', mColorLat, ...
...
% create plot of mu 6p-lat
plot2(numel(plot2)+1) = plot(x_b(:,3)*I(3),y_b2(:,3),...
    'Color',colors(7,:),...
    'LineWidth',1,'LineStyle',lStyles{1,1},...
    'Marker',mStyles_b{1,1},'MarkerSize',MarkerS,...
    'MarkerEdgeColor', mColorLat, ...
...
% create plot of mu 2p-lat
plot2(numel(plot2)+1) = plot(the_b(:,1)*I(1),y_b2(:,1),...
    'Color',colors(7,:),...
    'LineWidth',1,'LineStyle',lStyles{1,1},...
    'Marker',mStyles_b{1,3},'MarkerSize',MarkerS,...
    'MarkerFaceColor',mColorLat+0.502,...
...
% create plot of mu 4p-lat
plot2(numel(plot2)+1) = plot(the_b(:,2)*I(2),y_b2(:,2),...
    'Color',colors(7,:),...
    'LineWidth',1,'LineStyle',lStyles{1,1},...
    'Marker',mStyles_b{1,2},'MarkerSize',MarkerS,...
    'MarkerFaceColor',mColorLat+0.502,...
...
% create plot of mu 6p-lat
plot2(numel(plot2)+1) = plot(the_b(:,3)*I(3),y_b2(:,3),...
    'Color',colors(7,:),...
    'LineWidth',1,'LineStyle',lStyles{1,1},...
    'Marker',mStyles_b{1,1},'MarkerSize',MarkerS,...
    'MarkerFaceColor',mColorLat+0.502,...
...
% LINE UP
fMakeXgrid(0.002:0.002:0.008,[0,1.5],0.5);
fMakeYgrid([0,0.05],0.25:0.25:1.25,0.5);

% Create xlabel
xlabel('Slope correction b_* \cdot S [-]','FontSize',fontS,'FontName','TimesNewRoman');
% Create ylabel
ylabel('Discharge coefficient \mu_f [-]',...
    'FontSize',fontS,...
    'FontName','TimesNewRoman');  
...
if write2disc
    cd('figures');
    export_fig mufbxS0.png -png
    export_fig mufbxS0.eps -eps
    cd ..
    disp('Figure (mufbxS0) written to disc (figures folder).');
    close all;
end
