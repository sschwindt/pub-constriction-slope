function[] = fPlot_alphahxOCT(x_b, the_b, xInterp_2, xInterp_4, xInterp_6, xInterp_b, ...
...
% Create xlabel
xlabel('Relative upstream water depth h_* [-]',...
...
if write2disc
    cd('figures');
    export_fig alphahxOCT.png -png
    export_fig alphahxOCT.eps -eps
    cd ..
