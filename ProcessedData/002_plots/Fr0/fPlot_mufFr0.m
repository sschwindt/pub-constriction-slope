function[] = fPlot_mufFr0(x_b, the_b, xInterp_b, ...
...
% Create xlabel
xlabel('Relative upstream water depth h_* [-]','FontSize',fontS,'FontName','Arial');
% Create ylabel
...
% Create xlabel
xlabel('Slope correction Fr_0 \cdot S [-]','FontSize',fontS,'FontName','Arial');
% Create ylabel
ylabel('Discharge coefficient \mu_f [-]',...
    'FontSize',fontS,...
    'FontName','Arial');  
...
if write2disc
    cd('figures');
    export_fig mufFr0.png -png
    export_fig mufFr0.eps -eps
    cd ..
    disp('Figure (mufFr0) written to disc (figures folder).');
    close all;
end
