function[] = fPlot_bxFr0(x_a, x_b, the_a, the_b, xInterp_bIx, xInterp_b1, xInterp_b2, ...
...
% Create xlabel
xlabel('Relative contraction width b_* [-]','FontSize',fontS,'FontName','Arial');
% Create ylabel
...
if write2disc
    cd('figures');
    export_fig bxFr0.png -png
    export_fig bxFr0.eps -eps
    cd ..
    disp('Figure (bxFr0) written to disc (figures folder).');
    close all;
end
