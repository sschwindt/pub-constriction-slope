...
sourceName = '20160706_chezy_sectionwise.xlsx';
sourceRange = 'D4:H9';% contains geometry data of each cross-section
switch Qb
    case 0
        hRange = 'L4:P6';       % contains p1 and p2 values for linear interpolation
        targetRangeC = ['D16:G',num2str(15+numel(Q))];
        targetRangeK = ['C6:F',num2str(5+numel(Q))];
    case 1
        hRange = 'L7:P9';       % contains p1 and p2 values for linear interpolation
